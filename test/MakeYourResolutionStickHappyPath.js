...
// Test suite
contract('MakeYourResolutionStick', function(accounts) {
  var MakeYourResolutionStickInstance;
  ...
  it("should have 0 active goals", function() {
    return MakeYourResolutionStick.deployed().then(function(instance) {
      MakeYourResolutionStickInstance = instance;
  ...
  it("should let save a goal", function() {
    return MakeYourResolutionStick.deployed().then(function(instance) {
      ...
      contractBalanceBeforeGoal = web3.fromWei(web3.eth.getBalance(MakeYourResolutionStickInstance.address), 'ether').toNumber();
      ...
      assert.equal(web3.fromWei(web3.eth.getBalance(MakeYourResolutionStickInstance.address), 'ether').toNumber(), contractBalanceBeforeGoal + goal.amount, 'contract balance should increase by goal\'s amount');
      ...
      return MakeYourResolutionStickInstance.activeGoals(0);
    }).then(function(receipt) {
  ...
  it("should let save a second goal", function() {
    return MakeYourResolutionStick.deployed().then(function(instance) {
      ...
      assert.equal(web3.fromWei(web3.eth.getBalance(MakeYourResolutionStickInstance.address), 'ether').toNumber(), contractBalanceBeforeGoal + goal2.amount, 'contract balance should increase by goal\'s amount');
      assert.equal(ownerBalanceBeforeGoal, ownerBalanceAfterGoal, 'owner balance should be the same');
      assert(userBalanceAfterGoal <= userBalanceBeforeGoal - goal2.amount, 'user\'s balance should decrease by goal\'s amount');

      return MakeYourResolutionStickInstance.activeGoals(1);
    }).then(function(goal) {
  ...
  it("should set goal succeeded", function() {
    return MakeYourResolutionStick.deployed().then(function(instance) {
      ...
      return MakeYourResolutionStickInstance.setGoalSucceeded(0, hash, {
        from: owner
      });
    }).then(function(receipt) {
      ownerBalanceAfterGoal = web3.fromWei(web3.eth.getBalance(owner), 'ether').toNumber();
      ...
      assert.equal(web3.fromWei(web3.eth.getBalance(MakeYourResolutionStickInstance.address), 'ether').toNumber(), (contractBalanceBeforeGoal - goal.amount).toFixed(5), 'contract balance should decrease by goal\'s amount');
  ...
  it("should set second goal failed", function() {
    return MakeYourResolutionStick.deployed().then(function(instance) {
      ...
      return MakeYourResolutionStickInstance.setGoalFailed(1, hash, {
        from: owner
      });
    }).then(function(receipt) {
      userBalanceAfterGoal = web3.fromWei(web3.eth.getBalance(user), 'ether').toNumber();
      ownerBalanceAfterGoal = web3.fromWei(web3.eth.getBalance(owner), 'ether').toNumber();
      contractBalanceAfterGoal = web3.fromWei(web3.eth.getBalance(MakeYourResolutionStickInstance.address), 'ether').toNumber();
