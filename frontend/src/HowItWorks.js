	...
	<div id="how-it-works" className="container">
		<div className="row">
			...
			<div className="col-xs-12 col-md-10 col-md-push-1">
				...
				<p>Upon supervisor's response <b>"Make Your Resolution Stick"</b> smart contract will automatically send your funds back if you reached your goal, and will keep the funds otherwise.</p> 

				<p>You may interact with <b>"Make Your Resolution Stick"</b> smart directly by using Application Binary Interface (ABI).</p>
